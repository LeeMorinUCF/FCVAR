...
Loading FCVAR
Writing NAMESPACE
Writing plot.FCVARlikeGrid.Rd
Writing FCVARhypoTest.Rd
Writing FCVARforecast.Rd
-- Building ----------------------------------------------------------- FCVAR --
  Setting env vars:
...
-  checking whether 'INDEX' is up-to-date ... NO (586ms)
...
√  checking package dependencies (904ms)
√  checking if this is a source package ...
√  checking if there is a namespace
√  checking for executable files (419ms)
√  checking for hidden files and directories ...
√  checking for portable file names ...
√  checking whether package 'FCVAR' can be installed (4.3s)
√  checking installed package size ...
√  checking package directory
√  checking DESCRIPTION meta-information (342ms)
...
W  checking S3 generic/method consistency (510ms)
print:
  function(x, ...)
    print.FCVARestn:
...
√  checking for unstated dependencies in examples (616ms)
√  checking contents of 'data' directory
√  checking data for non-ASCII characters ...
√  checking data for ASCII and uncompressed saves ...
E  checking examples (2m 13.4s)
Running examples in 'FCVAR-Ex.R' failed
The error most likely occurred in:

  > base::assign(".ptime", proc.time(), pos = "CheckExEnv")
> ### Name: FCVARlike
  > ### Title: Likelihood Function for the Constrained FCVAR Model
  > ### Aliases: FCVARlike
  >
  > ### ** Examples
  >
...
Error in FCVARlike(c(results$coeffs$db, results$coeffs$muHat), x, k = 2,  :
                     could not find function "FCVARlike"
Execution halted
√  checking for unstated dependencies in 'tests' ...
-  checking tests ...
√  Running 'testthat.R' [50s] (49.9s)
...
1 error x | 2 warnings x | 0 notes √
>
