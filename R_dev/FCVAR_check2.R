...
-  preparing 'FCVAR': (13.2s)
√  checking DESCRIPTION meta-information ...
-  checking whether 'INDEX' is up-to-date ... NO (603ms)
...
√  checking package dependencies (938ms)
√  checking if this is a source package ...
√  checking if there is a namespace
√  checking for executable files (517ms)
...
Error in nrow(x) : object 'x1' not found
Calls: FCVARestn -> nrow
Execution halted
√  checking for unstated dependencies in 'tests' ...
-  checking tests ...
√  Running 'testthat.R' [49s] (48.8s)
...
1 error x | 3 warnings x | 1 note x
>
