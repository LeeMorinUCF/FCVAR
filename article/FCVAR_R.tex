...
This restriction produces a likelihood function with two local optima. 
The global optimum takes place at $\phi = 0.346$, 
which corresponds to $b = 0.546$ and $d = 0.591$, 
with a likelihood value of $451.36$.
A local maximum occurs at $\phi = 0.753$, 
which corresponds to $b = 0.953$ and $d = 1.405$, 
