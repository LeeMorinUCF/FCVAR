...
The \pkg{FCVAR} package ties together the features of these models in a multivariate framework that allows for an comprehensive set of testing options. 
...
Detecting equlibrium relationships between such variables can be problematic if this feature is not built into the model. 
% 
...
The model can also test equality and inequality restrictions on the fractional differencing parameters. 
In addition, any linear restriction on the short run autoregressive parameters is also a possibility. 
The maximum likelihhood framework allows for joint testing of any combination of these restrictions with a likelihood ratio test. 
...
Of the packages that estimate integer-order cointegration...
