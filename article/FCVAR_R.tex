...
The first line initializes the object \verb|opt| and assigns all of the default options set in \verb|EstOptions|. The user can see the full set of options by typing \verb|FCVARoptions| (or \verb|opt| after initialization) in the command line. % Listing~\ref{intl2} 
